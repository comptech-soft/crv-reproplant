module.exports = {
    ...
    watch: {
        'initial_image': {
            handler: function(newInitialImage, oldInitialImage)
            {
                if(newInitialImage.hasOwnProperty('s3_path'))
                {
                    console.log(newInitialImage.s3_path);
                }
                this.image = newInitialImage
            },
            deep: true
        }
    },
