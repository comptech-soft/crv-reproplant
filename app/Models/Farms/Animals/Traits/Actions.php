    ...
    protected static function InsertRecord($user_id, $record)
    {
        ...
        if( ! $animal_in_farm )
        {
            $record = self::insert($data = [
                ...
                'short_number' => array_key_exists('short_number', $record) ? $record['short_number'] : NULL,
                'internal_number' => array_key_exists('internal_number', $record) ? $record['internal_number'] : NULL,
                'created_at' => Carbon::now(),
                'created_by' => $user_id,
                'updated_at' => Carbon::now(),
                'updated_by' => $user_id,
